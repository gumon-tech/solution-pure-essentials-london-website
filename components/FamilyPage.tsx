...
function heroImageFor(category: CategoryId, groupId: GroupId) {
...
function RelatedCard({ page }: { page: FamilyPageData }) {
  const image = heroImageFor(page.category, page.groupId);
  return (
    <Link
...
export default function FamilyPage({ page }: { page: FamilyPageData }) {
  const heroImage = heroImageFor(page.category, page.groupId);
      ...
      {hasConsultationLine ? (
        <section className="mx-auto max-w-6xl px-4 py-8 md:px-6">
          <div className="grid items-center gap-8 lg:grid-cols-[1fr_1.2fr]">
            <ArchImage
              src={IMAGES["step-2-consultation"].fallback}
              alt={IMAGES["step-2-consultation"].alt}
              width={IMAGES["step-2-consultation"].width}
              height={IMAGES["step-2-consultation"].height}
              className="order-first w-full lg:order-none"
            />
